...
<form:errors path="user1.*"/>
	<a href="/springmvc8/login.html?siteLanguage=en">Login(English)</a>
	<a href="/springmvc8/login.html?siteLanguage=fr">Login(French)</a>  
	<a href="/springmvc8/login.html?siteLanguage=vi">Login(Vietnamese)</a>
